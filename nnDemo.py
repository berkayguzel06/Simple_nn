...
from simplenn.engine import ReLU, Softmax, Accuracy_Categorical, Accuracy_Regression, Categorical_Cross_Entropy, Mean_Square_Error, Adam, SGD
...
data, target = X4, y4
validation_data, validation_target = X4_val, y4_val
